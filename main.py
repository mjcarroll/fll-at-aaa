...
async def boat():
    ...
    """
    flag_turn = -400
    await gyro_drive_straight(450, velocity=600)

    await motor.run_for_degrees(ACC_HIGH, flag_turn, 1000)
    await motor.run_for_degrees(ACC_HIGH, -flag_turn, 1000)
...
async def surface_brushing_map_reveal():
    ...
    await motor.run_for_degrees(ACC_HIGH, -150, 500)
...
async def who_lived_and_forge():
    ...
    await runloop.sleep_ms(100)
    await turn_to_angle(450)
    await drive_straight(35, velocity=300)
